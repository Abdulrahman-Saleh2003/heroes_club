...
class CashHelper {
  ...
  static Future<bool> saveRememberPreference({required String rememberMe}) async {
    bool prefs = await sharedPreferences.setString('rememberMe', rememberMe);
    return prefs;

  }
  static String? getRemember() {
    return sharedPreferences.getString('rememberMe');
  }
